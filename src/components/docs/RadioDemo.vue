...
const colorSelected = ref("blue");
const disabledSelected = ref("normal");
const sizeSelected = ref("md");
const fruitSelected = ref("apple");
const horizontalSelected = ref("option-1");
</script>

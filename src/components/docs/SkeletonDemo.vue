  ...
  <div class="skeleton-examples">
    ...
    <section class="example-section">
      ...
      <CodeCollapsible :code="loadingCode">
        <p class="demo-note">
          Use <code>loading</code> prop — skeleton wraps content, shows placeholder while loading,
          reveals content when ready.
        </p>
        <div class="row gap-12 align-center" style="margin-bottom: 12px">
          <MizuButton type="button" size="sm" :loading-auto="true" @click="simulate">{{
            loading ? `Loading... ${elapsed.toFixed(1)}s` : "Reload"
          }}</MizuButton>
    ...
    <section class="example-section">
      ...
      <CodeCollapsible :code="themeCode">
        <p class="demo-note">
          <code>MizuSkeletonTheme</code> sets default props for all child skeletons — avoids
          repeating <code>baseColor</code>, <code>highlightColor</code>, etc. on every instance.
          Individual skeletons can still override by setting the prop directly.
        </p>
        <div class="stack">
            ...
            <MizuSkeletonTheme base-color="brand-primary" highlight-color="brand-primary-subtle">
              <div class="row gap-12 align-center">
                ...
                <MizuSkeleton
                  ...
                  :width="160"
                  :lines="2"
                  base-color="feedback-success-base"
                />
              </div>
            </MizuSkeletonTheme>
          </div>

...
<template>
  <div class="toggle-group-examples">
    <section class="example-section">
      ...
      <CodeCollapsible :code="singleCode">
        ...
        <MizuToggleGroupRoot v-model="textFormat" type="single" size="md">
          <MizuToggleGroupItem value="bold"
            ><Bold :size="14" /><span>Bold</span></MizuToggleGroupItem
          >
          <MizuToggleGroupItem value="italic"
            ><Italic :size="14" /><span>Italic</span></MizuToggleGroupItem
          >
          <MizuToggleGroupItem value="underline"
            ><Underline :size="14" /><span>Underline</span></MizuToggleGroupItem
          >
        </MizuToggleGroupRoot>
        <p class="demo-note">
          Selected: <code>{{ textFormat }}</code>
        </p>
      </CodeCollapsible>
    </section>
    ...
    <section class="example-section">
      ...
      <CodeCollapsible :code="multipleCode">
        <p class="demo-note">
          Multiple items can be active. Use for filters or independent options.
        </p>
        ...
        <p class="demo-note">
          Selected: <code>{{ multiFormat.join(", ") || "none" }}</code>
        </p>
      </CodeCollapsible>
    </section>
        ...
        <div class="row gap-12 align-center">
          <MizuToggleGroupRoot v-model="textFormat" type="single" size="md">
            <MizuToggleGroupItem value="bold"
              ><Bold :size="14" /><span>Bold</span></MizuToggleGroupItem
            >
            <MizuToggleGroupItem value="italic" disabled
              ><Italic :size="14" /><span>Italic</span></MizuToggleGroupItem
            >
            <MizuToggleGroupItem value="underline"
              ><Underline :size="14" /><span>Underline</span></MizuToggleGroupItem

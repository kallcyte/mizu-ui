...
const buttonGroupCode = `<MizuTabsRoot default-value="monthly">
  ...
  <MizuTabsContent value="monthly">
    <p>Analyze monthly trends, revenue, and growth metrics.</p>
  </MizuTabsContent>
</MizuTabsRoot>`;

const sizesUnderlineCode = `<MizuTabsRoot default-value="tab1">
  <MizuTabsList size="sm">
    <MizuTabsTrigger value="tab1">Account</MizuTabsTrigger>
    <MizuTabsTrigger value="tab2">Security</MizuTabsTrigger>
  </MizuTabsList>
  <MizuTabsContent value="tab1">
    <p>Small underline content.</p>
  </MizuTabsContent>
</MizuTabsRoot>`;

const sizesButtonCode = `<MizuTabsRoot default-value="tab1">
  <MizuTabsList size="md" variant="button">
    <MizuTabsTrigger value="tab1">Tab One</MizuTabsTrigger>
    <MizuTabsTrigger value="tab2">Tab Two</MizuTabsTrigger>
  </MizuTabsList>
  <MizuTabsContent value="tab1">
    <p>Medium size content.</p>
  </MizuTabsContent>
</MizuTabsRoot>`;
  ...
  <MizuTabsContent value="general">
    <div class="tab-panel">
      ...
      <div class="field-group">
        ...
        <p>Name displayed across the platform.</p>
      </div>
      <div class="actions">
        <MizuButton variant="outline">Cancel</MizuButton>
        <MizuButton>Save Changes</MizuButton>
      </div>
    </div>
  </MizuTabsContent>
  <!-- ... other tab contents ... -->
...
const colorVariantsCode = `<MizuTabsRoot defaultValue="tab1">
  <MizuTabsList color="accent">
    <MizuTabsTrigger value="tab1">Account</MizuTabsTrigger>
...
const asyncContentCode = `<MizuTabsRoot v-model="asyncTab" defaultValue="users">
  ...
  <MizuTabsContent value="users">
    <div v-if="asyncLoading">Loading…</div>
    <ul v-else-if="asyncData.users">

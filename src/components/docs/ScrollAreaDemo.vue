  ...
  <div class="scroll-area-examples">
    <section class="example-section">
      ...
      <CodeCollapsible :code="verticalCode">
        <p class="demo-note">
          Hover to reveal the scrollbar. Content taller than <code>max-height</code> becomes
          scrollable.
        </p>
    ...
    <section class="example-section">
      ...
      <CodeCollapsible :code="horizontalCode">
        <p class="demo-note">
          Wide content constrained by <code>max-width</code> — horizontal scrollbar appears.
        </p>
        <MizuScrollAreaRoot :max-width="360" class="sa-card">
          <MizuScrollAreaViewport class="sa-pad">
            <div class="h-scroll-row">
              <span v-for="t in [...tags, ...tags]" :key="t + Math.random()" class="tag-chip">{{
                t
              }}</span>
            </div>
          </MizuScrollAreaViewport>
    ...
    <section class="example-section">
      ...
      <CodeCollapsible :code="bothCode">
        <p class="demo-note">
          A large grid constrained in both dimensions — vertical + horizontal scrollbars with a
          corner.
        </p>
    ...
    <section class="example-section">
      ...
      <CodeCollapsible :code="alwaysCode">
        <p class="demo-note">
          <code>type="always"</code> keeps the area open without a scrollbar — scrollbars appear
          permanently.
        </p>

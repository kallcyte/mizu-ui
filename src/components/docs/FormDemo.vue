...
import { MizuForm, MizuFormField, MizuInput, MizuButton, type ValidationError } from "@mizu/vue";
    ...
    <section class="example-section">
      ...
      <CodeCollapsible :code="basicCode">
        ...
        >
          ...
          <MizuButton variant="primary" size="md" type="submit" class="w-max"> Log In </MizuButton>
